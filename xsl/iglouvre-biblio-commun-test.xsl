 ...
 -->
    ...
    <xsl:template name="creators">
        ...
        <xsl:for-each select="tei:author|tei:editor|tei:respStmt">
            <xsl:call-template name="makeCreator">
                ...
                <xsl:with-param name="nbrAuthors">
                    <xsl:value-of select="count(parent::tei:*/tei:author)"/>
                </xsl:with-param>
                <xsl:with-param name="separator">
                   
                    <xsl:choose>
                        <xsl:when test="count(parent::tei:*/tei:author) = 1">
                            <xsl:text>$</xsl:text>
                        </xsl:when>
    ...
    <xsl:template name="makeCreator">
        ...
        <xsl:choose>
            ...
            <xsl:when test="local-name()='editor'"> </xsl:when>
